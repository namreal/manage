<?php
    ...
    if (isset($_POST['revenue'])) 
	{
		...
		$moneys = isset($_POST['moneys']) ? $_POST['moneys'] : '';
		...
		if($date == "" && $moneys == "" && $note == ""){
			echo'<script language="javascript">alert("Nhập đầy đủ thông tin");window.location="index.php";</script>';
		}
		$sql = "INSERT INTO `thu` (`date`, `moneys`, `note`)
                VALUES ('$date','$moneys', '$note')";
	  	$exec=$DB->query($sql);
        if($exec){
            echo'<script language="javascript">alert("Thêm thành công!!!!");window.location="index.php";</script>';
        }
        if(!$exec){
            echo'<script language="javascript">alert("Thêm thất bại !!!!");window.location="index.php";</script>';
        }
  	}

    
    $sql_rec = 'SELECT count(id) as total FROM thu';
    ...
    $sql_thu = "SELECT * FROM thu LIMIT $start, $limit";
...
<head>
    ...
    <!-- Title Page-->
    <title>Thông tin các khoản thu</title>
                ...
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="flexbox">
                            ...
                            <div display="flex">
                                <label>Số tiền: </label>
                                <input class="input" type="number" name="moneys" />
                            </div>
                        </div>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td><?php echo $row['moneys']; ?> VNĐ</td>
                                                <td><?php echo $row['note']; ?></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="edit_thu.php?id=<?php echo $row['id']; ?>"><button
                                                                class="item" data-toggle="tooltip" data-placement="top"
                                                                title="Edit" id="editBtn">
                                                                <i class="zmdi zmdi-edit"></i>
                                                            </button></a>
                                                        <a href="dltthu.php?id=<?php echo $row['id']; ?>"><button
                                                                class="item" data-toggle="tooltip" data-placement="top"
                                                                title="Delete">
